  ...
  return (
    <section id="projects" className="py-16 sm:py-24 md:py-28 border-b border-border/30 bg-background relative">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Projects Showcase - 3 Column Layout */}
        {projects.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-7 lg:gap-8">
            {projects.map((project, index) => (
              <motion.div
                ...
                className="group rounded-2xl sm:rounded-3xl border border-border/80 dark:border-white/10 bg-card dark:bg-[#0B1220] shadow-xl dark:shadow-2xl overflow-hidden flex flex-col justify-between transition-all duration-300 hover:border-primary/40 hover:-translate-y-1"
              >
                {/* Card Cover Image */}
